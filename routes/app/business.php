        ...
        Route::prefix('customers')
            ...
            ->group(function () {
                Route::get('/', CustomersIndex::class)
                    ->name('index')
                    ->middleware(['role:admin|agente']);
                Volt::route('edit/{id}', 'business.customers.edit')
                    ->name('edit')
        ...
        Route::prefix('agents')
            ...
            ->group(function () {
                Route::get('/', AgentsIndex::class)
                    ->name('index')
                    ->middleware(['role:admin']);
                Volt::route('edit/{id}', 'business.agents.edit')
                    ->name('edit')
                    ->middleware(['role:admin']);
        ...
        Route::prefix('teams')
            ...
            ->group(function () {
                Route::get('/', TeamsIndex::class)
                    ->name('index')
                    ->middleware(['role:admin']);
                Volt::route('edit/{id}', 'business.teams.edit')
                    ->name('edit')
                    ->middleware(['role:admin']);
            });
        ...
        Route::prefix('assignments')
            ...
            ->group(function () {
                Route::get('/', AssignmentsIndex::class)
                    ->name('index')
                    ->middleware(['role:admin']);
                Volt::route('edit/{id}', 'business.assignments.edit')
                    ->name('edit')
                    ->middleware(['role:admin']);
            });
